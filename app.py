...
def launch_chrome_web_interface():
    ...
    crest_logo_filename = "ProofPixel_The Authentication Crest_logo_brand_tagline_TM_15Aug26.png"
    ...
    with col_title:
        st.markdown('<h1 class="single-line-header">ProofPixel: A real time platform for distinguishing AI-generated vs. Human-authored text, images, videos</h1>', unsafe_allow_html=True)
